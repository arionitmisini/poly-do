        ...
        <div className="register">
            ...
            <div className="row">
                ...
                <form action="create-profile.html">
                    ...
                    <div className="form-group">
                    <input type="text" className="form-control form-control-lg" placeholder="Surname" name="surname" />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                    <input type="date" className="form-control form-control-lg" placeholder="Date" name="date" />
                    </div>
